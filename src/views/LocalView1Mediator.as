package views
{
	...
	public class LocalView1Mediator extends Mediator
	{
		[Inject]
		public var view:LocalView1;
		...
		{
			logger.info( "Local View 1 Initialized" );
		...
		private function sendMessageHandler( event:MouseEvent ):void
		{
			...
			{
				case "global":
					globalDispatcher.dispatchEvent( new TextMessageEvent( TextMessageEvent.TEXT_MESSAGE, "Local View 1: Hello!!" ) );
					break;
				
				case "moduleOnly":
					moduleOnlyDispatcher.dispatchEvent( new TextMessageEvent( TextMessageEvent.TEXT_MESSAGE, "Local View 1: Hello!!" ) );
					break;
				
				case "toModule1":
					toModule1Dispatcher.dispatchEvent( new TextMessageEvent( TextMessageEvent.TEXT_MESSAGE, "Local View 1: Hello!!" ) );
					break;
				
				case "toModule2":
					toModule2Dispatcher.dispatchEvent( new TextMessageEvent( TextMessageEvent.TEXT_MESSAGE, "Local View 1: Hello!!" ) );
					break;
			}
		}
